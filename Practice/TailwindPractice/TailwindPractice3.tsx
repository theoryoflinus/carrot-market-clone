...
const TailwindPractice3: NextPage = () => {
    return (
        <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
            {/* Creating 3 basic widgets using modifiers */}
            {/* First Widget */}
            <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
                ...
                <div
                    className="mt-5 bg-blue-500 dark:bg-black dark:border-white dark:border
                text-white p-3 text-center rounded-xl w-2/4 mx-auto
            ...
            <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
                ...
                <div className="rounded-3xl p-6 bg-white relative -top-5">
                    <div className="flex relative -top-16 items-end justify-between">
                        ...
                        <div className="h-24 w-24 bg-zinc-300 rounded-full group group-hover:bg-red-300 transition-colors" />
                        <div className="flex flex-col items-center">
...
export default TailwindPractice3;
